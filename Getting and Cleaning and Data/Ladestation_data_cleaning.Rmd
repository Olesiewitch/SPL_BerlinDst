---
title: "Ladestation_data_cleaning"
author: "Wu Qi"
date: "1/17/2019"
output: pdf_document
---
...
```{r}
library(readxl)
Postleitzahlen = read_excel("~/SPL-Project/Dirstrict Data/ZuordnungderBezirkezuPostleitzahlen.xls")
...
```{r}
ladestationen = read_excel("~/SPL-Project/Dirstrict Data/ladestationen.xls")
#extract post code in column 'ladestationen$Adresse', where information is listed as e.g. "Malteserstrasse 136<U+2013>138, 12249 Berlin", and create a new column with post code
