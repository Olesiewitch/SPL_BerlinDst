...
zips2=(matrix(unlist(getting_zip(stops.data$stop_lon[4001:8001],stops.data$stop_lat[4001:8001]))))
zips3=(matrix(unlist(getting_zip(stops.data$stop_lon[8002:12002],stops.data$stop_lat[8002:12002]))))
zips4=(matrix(unlist(getting_zip(stops.data$stop_lon[12003:16003],stops.data$stop_lat[12003:16003]))))
zips5=(matrix(unlist(getting_zip(stops.data$stop_lon[16004:20004],stops.data$stop_lat[16004:20004]))))
zips6=(matrix(unlist(getting_zip(stops.data$stop_lon[20005:24005],stops.data$stop_lat[20005:24005]))))
zips7=(matrix(unlist(getting_zip(stops.data$stop_lon[24006:28006],stops.data$stop_lat[24006:28006]))))
zips8=(matrix(unlist(getting_zip(stops.data$stop_lon[28007:32007],stops.data$stop_lat[28007:32007]))))
zips9=(matrix(unlist(getting_zip(stops.data$stop_lon[32008:36008],stops.data$stop_lat[32008:36008]))))
zips10=(matrix(unlist(getting_zip(stops.data$stop_lon[3609:40009],stops.data$stop_lat[3609:40009]))))
...
zips11=(matrix(unlist(getting_zip_short(stops.data$stop_lon[40010:41750],stops.data$stop_lat[40010:41750]))))
