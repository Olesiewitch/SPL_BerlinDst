...
Physical_index_1=apply(livibility_index[34:37],1,sum)
Physical_index_2=apply(livibility_index[38:41], 1,sum)
Social_index=apply(livibility_index[42:57],1,sum)
Economic_index=apply(livibility_index[58:61],1,sum)
Enviromental_index= apply(livibility_index[62:64],1,sum) ### Alex
