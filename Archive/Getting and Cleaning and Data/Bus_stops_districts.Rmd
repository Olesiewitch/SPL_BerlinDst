...
```{r}
library(readr)
stat <- read_csv("~/SPL-Project/Dirstrict Data/stops+zip.csv")
View(stat)

sum(is.na(as.numeric(stat$zip)))# 674
which(is.na(as.numeric(stat$zip)))
...
# Write csv file
count_stops <- c(597,  604, 1336,  661,  901, 1164,  948, 1023, 1175,  908,  720, 1726)
