...
ppltUrl = read_html(paste0("https://www.statistik-berlin-brandenburg.de/",
                          "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410",
                          "&Sageb=13003&creg=BBB&anzwer=6"))

szUrl = read_html(past0("https://www.statistik-berlin-brandenburg.de/",
                        "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410",
                        "&Sageb=33000&creg=BBB&anzwer=8"))

srfUrl = read_html(past0("https://www.statistik-berlin-brandenburg.de/",
                         "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410", 
                         "&Sageb=33000&creg=BBB&anzwer=8"))

hshlUrl =  read_html (past0("https://www.statistik-berlin-brandenburg.de/", 
                            "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410",
                            "&Sageb=12011&creg=BBB&anzwer=5"))

stdtUrl = read_html(paste0("https://www.statistik-berlin-brandenburg.de/",
                           "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410",
                            "&Sageb=21001&creg=BBB&anzwer=5&fbclid=IwAR0d7",
                            "Ebm0uLtl5cc81O49tvFXeW0PRU_jEFh2qaCLWl1G2XSFv7",
                            "mnb-SmwU")

immbUrl = read_html(paste0("https://www.statistik-berlin-brandenburg.de/",
                           "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410", 
                           "&Sageb=31000&creg=BBB&anzwer=0"))

trsmUrl = read_html(paste0("https://www.statistik-berlin-brandenburg.de/",
                           "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410",
                           "&Sageb=45005&creg=BBB&anzwer=7"))

soclUrl = read_html(past0("https://www.statistik-berlin-brandenburg.de/",
                          "regionalstatistiken/r-gesamt_neu.asp?Ptyp=410",
                          "&Sageb=22001&creg=BBB&anzwer=5"))
