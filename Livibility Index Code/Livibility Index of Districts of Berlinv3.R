...
final_data_frame = data.frame(stat_arr,fbinter_ar,berliner_ar,doctor_arr,kriminal_arr,statistik_arr,
...
colnames(final_data_frame)=c(colnames(stat_arr),colnames(fbinter_stadt_berlin_daten[2:3]),
                             ...
                             colnames(statistik_daten[4]),"charging_station","bus_stops","Nr_of_restaurants")
